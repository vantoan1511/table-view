        ...
        <div class="flex flex-1 min-h-0">
          ...
          <div class="w-[180px] bg-sidebar border-r border-border py-3 flex flex-col">
            ...
            <div class="px-3 pt-2 border-t border-border mt-2">
              <button class="flex items-center gap-2 w-full px-3 py-2 text-[12px] text-text-secondary hover:text-text-primary hover:bg-hover rounded-lg transition-colors cursor-pointer">
                <Download :size="14" />
          ...
          <div class="flex-1 flex flex-col min-h-0">
            ...
            <div class="flex items-center gap-1 px-5 pt-3 pb-0 border-b border-border">
              <button
                ...
                :key="tab"
                class="px-3 py-2 text-[13px] font-medium capitalize transition-colors cursor-pointer -mb-px"
                :class="
                  activeTab === tab
            ...
            <div class="flex-1 overflow-y-auto px-5 py-4">
              <div v-if="activeTab === 'general'" class="grid grid-cols-2 gap-x-6 gap-y-4">
                ...
                <div>
                  ...
                  <input
                    v-model.number="form.connectionTimeout"
                    type="number"
                    class="w-full px-3 py-2 border border-border rounded-lg text-[13px] text-text-primary bg-surface focus:border-primary focus:ring-1 focus:ring-primary/20 outline-none transition-all"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    v-model.number="form.queryTimeout"
                    type="number"
                    class="w-full px-3 py-2 border border-border rounded-lg text-[13px] text-text-primary bg-surface focus:border-primary focus:ring-1 focus:ring-primary/20 outline-none transition-all"
                  />
                </div>
                ...
                <!-- Comment -->
                <div>
                  <label class="block text-[12px] font-medium text-text-secondary mb-1.5">Comment <span class="font-normal text-text-tertiary">(optional)</span></label>
                  <textarea
                    v-model="form.comment"
                    rows="3"
                    placeholder="Add any notes about this connection..."
                    class="w-full px-3 py-2 border border-border rounded-lg text-[13px] text-text-primary bg-surface placeholder-text-tertiary focus:border-primary focus:ring-1 focus:ring-primary/20 outline-none transition-all resize-y"
                  ></textarea>
                </div>
              </div>
          ...
          <div class="flex items-center gap-3">
            ...
            <span class="flex items-center gap-1.5 text-[12px]">
              ...
              <span class="text-text-secondary">
                {{ testStatus === 'ready' ? 'Ready to test' : testStatus === 'testing' ? 'Testing...' : testStatus === 'success' ? 'Connection successful!' : 'Connection failed' }}
              </span>
            </span>
          </div>
