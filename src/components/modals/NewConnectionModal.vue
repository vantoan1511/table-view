...
import { CircleHelp, Download, Eye, EyeOff, Loader2, Send } from 'lucide-vue-next';
...
<template>
  <Dialog
    :visible="connectionsStore.showNewConnectionModal"
    modal
    :closable="true"
    :style="{ width: '58rem' }"
    :pt="{
  ...
  >
    ...
    <!-- Body -->
    <div class="flex max-h-[70vh] min-h-120">
        ...
        <div class="flex-1 overflow-y-auto px-5 py-4">
          <div v-if="activeTab === 'general'" class="grid grid-cols-2 gap-x-6 gap-y-4">
            ...
            <div class="relative">
              ...
              <div class="relative">
                <!-- Flag Preview -->
                <div
                  class="absolute top-0 bottom-0 left-0 z-10 w-1 rounded-l-md transition-colors duration-200"
            ...
            <!-- Host -->
            <div>
              <label class="text-text-secondary mb-1.5 block text-[12px] font-medium">Host</label>
              <InputText v-model="form.host" type="text" fluid />
            </div>

            <!-- Port -->
            <div>
              <label class="text-text-secondary mb-1.5 block text-[12px] font-medium">Port</label>
              <InputNumber v-model="form.port" :use-grouping="false" fluid />
            </div>
            ...
            <div>
              ...
              <InputText v-model="form.database" type="text" fluid />
            </div>
            ...
            <div>
              <label class="text-text-secondary mb-1.5 block text-[12px] font-medium"
                ...
                ></label
              >
              <InputText v-model="form.tags" type="text" placeholder="e.g. PROD, DEV" fluid />
            </div>
          ...
          <div v-else-if="activeTab === 'ssl'" class="grid grid-cols-2 gap-x-6 gap-y-4">
            ...
            <div v-if="form.type === 'postgresql'" class="col-span-2">
              ...
              <p class="text-text-tertiary mt-1.5 text-[11px]">
                "Prefer" automatically negotiates SSL for cloud databases (Supabase, Neon, AWS RDS,
                PgBouncer) while working with local databases.
              </p>
            </div>
          </div>
          ...
          <div v-else class="text-text-secondary text-[13px]">
            <div v-if="form.type === 'oracle'" class="grid grid-cols-2 gap-x-6 gap-y-4">
              ...
              <div>
                <label class="text-text-secondary mb-1.5 block text-[12px] font-medium">Role</label>
                <Select
