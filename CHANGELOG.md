...
- **CI/CD**: Renewed WinGet PAT secret to restore `winget-pkgs` PR submission via komac.
...
- **CI/CD**: Fixed `komac` CLI path resolution in WinGet community release step.

## [0.6.2] - 2026-07-25

### Fixed

- **CI/CD**: Updated release workflow configuration and permissions.
