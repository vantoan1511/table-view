...
/// Privileged authentication role.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default)]
pub enum AuthMode {
    /// Normal database authentication.
    #[default]
    Normal,
    /// Authenticate as SYSDBA.
    SysDba,
    /// Authenticate as SYSOPER.
    SysOper,
}
...
impl Config {
    ...
    /// Set privileged authentication mode.
    ...
    /// Authenticate as SYSDBA.
    pub fn with_sysdba(self) -> Self {
        self.auth_mode(AuthMode::SysDba)
    }

    /// Authenticate as SYSOPER.
    pub fn with_sysoper(self) -> Self {
        self.auth_mode(AuthMode::SysOper)
    }
